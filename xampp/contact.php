...
.bottom-right{
background: url(../images/pool2.jpg) no-repeat 0px 0px;
background-size: cover;
...
.twitt-grid-middle{
  background: url(../images/restaurant.jpg) no-repeat 0px 0px;
  background-size: cover;
  -webkit-background-size: cover;
  -moz-background-size: cover;
  -o-background-size: cover;
...
.twitt-grid-right{
  background: url(../images/water.jpg) no-repeat 0px 0px;
  background-size: cover;
  -webkit-background-size: cover;
  -moz-background-size: cover;
  -o-background-size: cover;
